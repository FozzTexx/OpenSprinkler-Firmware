...
elif [ "$1" == "ospi_low" ]; then
	g++ -o OpenSprinkler -DOSPI -DACTIVE_LOW main.cpp OpenSprinkler.cpp program.cpp server.cpp utils.cpp weather.cpp gpio.cpp etherport.cpp
else
